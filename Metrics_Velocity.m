function [ Mean_v ] = Metrics_Velocity( Mode_visual, Pos_Last2Targets, Time_ReachTargets1, Time_ReachTargets2)
...
%     Mean_v = abs(Pos_Last2Targets(2)-Pos_Last2Targets(1))/(Time_ReachTargets(2)-Time_ReachTargets(1));    
    Mean_v = abs(Pos_Last2Targets(1,2)-Pos_Last2Targets(1,1))/etime(Time_ReachTargets1,Time_ReachTargets2); 
...
%     Mean_v = norm(Pos_Last2Targets(:,1)-Pos_Last2Targets(:,2))/(Time_ReachTargets(2)-Time_ReachTargets(1));  
    Mean_v = norm(Pos_Last2Targets(:,1)-Pos_Last2Targets(:,2))/etime(Time_ReachTargets1,Time_ReachTargets2); 
end
